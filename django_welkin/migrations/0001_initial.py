# Generated by Django 4.1.2 on 2022-11-02 23:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "middle_name",
                    models.CharField(
                        max_length=255, null=True, verbose_name="middle name"
                    ),
                ),
                ("birth_date", models.DateField(null=True)),
                (
                    "gender",
                    models.CharField(max_length=255, null=True, verbose_name="gender"),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="django_welkin.instance"
            ),
        ),
        migrations.AddField(
            model_name="patient",
        ...
        migrations.AddField(
            ...
            name="tenant",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="django_welkin.tenant"
            ),
        ),
        migrations.AddField(
            model_name="chat",
